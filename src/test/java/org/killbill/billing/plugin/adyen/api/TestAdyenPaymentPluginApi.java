...
public class TestAdyenPaymentPluginApi extends TestAdyenPaymentPluginApiBase {
    ...
    private static final Map<String,String> three3DSAccountInfo = ImmutableMap.<String,String>builder()
            .put(AdyenPaymentPluginApi.ACCOUNT_AGE_INDICATOR,"11111")
            .put(AdyenPaymentPluginApi.ACCOUNT_CHANGE_DATE,"2009-05-07T17:05:45.678Z")
            .put(AdyenPaymentPluginApi.ACCOUNT_CHANGE_INDICATOR,"1111")
            ...
            .put(AdyenPaymentPluginApi.PASSWORD_CHANGE_DATE_INDICATOR, "1111")
            .put(AdyenPaymentPluginApi.PURCHASES_LAST_6_MONTHS,"1111")
            .put(AdyenPaymentPluginApi.ADD_CARD_ATTEMPTS_DAY, "1111")
            .put(AdyenPaymentPluginApi.PAST_TRANSACTIONS_DAY, "1111")
            .put(AdyenPaymentPluginApi.PAST_TRANSACTIONS_YEAR, "1111")
            .put(AdyenPaymentPluginApi.PAYMENT_ACCOUNT_AGE, "1111")
            .put(AdyenPaymentPluginApi.PAYMENT_ACCOUNT_INDICATOR, "111")
            .put(AdyenPaymentPluginApi.DELIVERY_ADDRESS_USAGE_DATE,"2009-05-07T17:05:45.678Z")
            .put(AdyenPaymentPluginApi.DELIVERY_ADDRESS_USAGE_INDICATOR, "111")
            .put(AdyenPaymentPluginApi.SUSPICIOUS_ACTIVITY, "true")
            .put(AdyenPaymentPluginApi.HOME_PHONE, "1111")
            .put(AdyenPaymentPluginApi.WORK_PHONE,"1111")
            .put(AdyenPaymentPluginApi.MOBILE_PHONE, "1111")
            .build();
